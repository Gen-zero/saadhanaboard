...
const ManifestationForm = ({ onClose }: ManifestationFormProps) => {
  ...
  return (
    <div className="relative">
      <Card className="border border-purple-500/20 bg-background/70 backdrop-blur-sm">
        <CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Textarea 
              ...
              className="min-h-[150px] bg-background/50 border border-purple-500/30 placeholder:text-muted-foreground/50 
              text-foreground focus-visible:ring-purple-500/50 resize-none"
