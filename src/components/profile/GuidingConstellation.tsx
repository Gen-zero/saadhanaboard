...
const GuidingConstellation = ({ goals, className = '' }: GuidingConstellationProps) => {
  ...
  return (
    <Card className={`backdrop-blur-sm bg-background/70 border border-purple-500/20 relative overflow-hidden ${className}`}>
      {/* Celestial background */}
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/30 via-purple-900/20 to-fuchsia-900/30">
        {/* Animated stars */}
        {[...Array(50)].map((_, i) => (
          <div
            key={i}
      ...
      <CardContent className="relative z-10">
        ...
        <div className="relative h-64 rounded-lg border border-purple-500/20 bg-black/20 backdrop-blur-sm">
        ...
        <DialogContent className="max-w-md">
          ...
          {selectedGoal && (
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-gradient-to-r from-purple-500/20 to-fuchsia-500/20">
