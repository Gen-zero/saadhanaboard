    ...
    <Card className={`backdrop-blur-sm bg-background/70 border border-purple-500/20 ${className}`}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-3 rounded-lg bg-background/50 hover:bg-purple-500/10 transition-all duration-300 border border-transparent hover:border-purple-500/30">
          ...
          <div className="col-span-1 md:col-span-2 p-3 rounded-lg bg-background/50 hover:bg-purple-500/10 transition-all duration-300 border border-transparent hover:border-purple-500/30">
            <p className="text-sm text-muted-foreground flex items-center gap-1">
