  ...
  return (
    <>
      <div className="absolute inset-0 z-0 pointer-events-none admin-bg-layer">
        ...
        {/* faint floating yantras */}
        <div className="floating-yantra gold-accent" style={{ left: '75%', top: '20%', fontSize: '2rem' }}>✦</div>
        <div className="ambient-mantra" style={{ left: '10%', bottom: '20%' }}>ॐ</div>
      </div>
    </>
  );
};
