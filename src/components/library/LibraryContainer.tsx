    ...
    <div className="flex flex-col gap-4 px-3 md:px-0">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="books" className="space-y-4">
          ...
          <div className="mb-4 p-3 md:p-4 bg-gradient-to-r from-purple-500/10 to-fuchsia-500/10 rounded-lg border border-purple-500/20">
          ...
          {isLoading ? (
            ...
            <>
              ...
              {/* Pagination controls */}
              {total > 0 && (
                <div className="flex flex-col md:flex-row items-center justify-between mt-6 p-4 rounded-lg border border-purple-500/20 bg-gradient-to-r from-purple-500/5 to-fuchsia-500/5">
        ...
        <TabsContent value="store">
          <div className="mb-4 p-3 md:p-4 bg-gradient-to-r from-purple-500/10 to-fuchsia-500/10 rounded-lg border border-purple-500/20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <Link to="/store">
                <Button className="bg-gradient-to-r from-purple-500 to-fuchsia-500 hover:from-purple-600 hover:to-fuchsia-600 text-sm md:text-base">
